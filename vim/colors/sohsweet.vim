...
" ViM Theme File Highlighting
hi vimGroup											ctermfg=214   ctermbg=NONE  cterm=NONE          guifg=NONE      guibg=NONE      gui=underline
hi vimHiGroup										ctermfg=214   ctermbg=NONE  cterm=NONE          guifg=NONE      guibg=NONE      gui=underline
hi vimHiCterm										ctermfg=76    ctermbg=NONE  cterm=NONE          guifg=NONE      guibg=NONE      gui=underline
hi vimHiCtermFgBg								ctermfg=76    ctermbg=NONE  cterm=NONE          guifg=NONE      guibg=NONE      gui=underline
hi vimHiGui											ctermfg=27    ctermbg=NONE  cterm=NONE          guifg=NONE      guibg=NONE      gui=underline
hi vimHiGuiFgBg									ctermfg=27    ctermbg=NONE  cterm=NONE          guifg=NONE      guibg=NONE      gui=underline
...
hi coffeeObjAssign            	ctermfg=29    ctermbg=NONE  cterm=NONE          guifg=#8c8c8c   guibg=NONE      gui=NONE
hi coffeeExtendeddOp	          ctermfg=205   ctermbg=NONE  cterm=NONE          guifg=#8c8c8c   guibg=NONE      gui=NONE
